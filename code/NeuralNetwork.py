# Schematic architecture for levels
# ---------------------------------
# level 0    -  level 0.5    - level 1      - level 1.5    - level 2      - level 2.5    - level 3
# InputLayer -  WeightsLayer - HiddenLayer1 - WeightsLayer - HiddenLayer2 - WeightsLayer - OuputLayer
